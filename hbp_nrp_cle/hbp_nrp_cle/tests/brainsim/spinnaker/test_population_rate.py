...
import unittest
from hbp_nrp_cle.brainsim.pynn_spiNNaker.devices.__PyNNSpiNNakerPopulationRate import PyNNSpiNNakerPopulationRate
...
class TestPopulationRate(unittest.TestCase):
    ...
    def test_population_rate_supported(self, sim_mock):
        ...
        sim_mock.Population()[0].tau_syn_E = 10.0
        sim_mock.Population()[0].cm = 1.0
        dev = PyNNSpiNNakerPopulationRate()
