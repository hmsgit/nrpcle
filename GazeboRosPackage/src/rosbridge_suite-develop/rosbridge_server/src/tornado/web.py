...
from tornado.util import bytes_type, import_object, ObjectDict
from tornado.util import raise_exc_info, unicode_type, _websocket_mask
    ...
    **Subclassing notes**
    ...
    def set_headers(self):
        ...
        cache_time = self.get_cache_time(
            self.path, self.modified, content_type)
        if cache_time > 0:
...
# A leading version number in decimal with no leading zeros, followed by a
# pipe.
