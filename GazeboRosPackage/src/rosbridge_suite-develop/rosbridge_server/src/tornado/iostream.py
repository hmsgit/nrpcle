...
if hasattr(errno, "WSAECONNRESET"):
    _ERRNO_CONNRESET += (
        errno.WSAECONNRESET, errno.WSAECONNABORTED, errno.WSAETIMEDOUT)
...
class IOStream(BaseIOStream):
    ...
    def start_tls(self, server_side, ssl_options=None, server_hostname=None):
        ...
        ssl_stream._ssl_connect_callback = lambda: future.set_result(
            ssl_stream)
...
class SSLIOStream(IOStream):
    ...
    def _verify_cert(self, peercert):
        ...
        assert verify_mode in (
            ssl.CERT_NONE, ssl.CERT_REQUIRED, ssl.CERT_OPTIONAL)
