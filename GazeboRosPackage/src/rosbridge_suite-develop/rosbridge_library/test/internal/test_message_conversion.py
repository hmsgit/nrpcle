...
class TestMessageConversion(unittest.TestCase):
    ...
    def test_signed_int_base_msgs(self):
        ...
        for int16 in int16s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int16, "std_msgs/Byte")
            self.assertRaises(
                Exception, self.do_primitive_test, int16, "std_msgs/Int8")
        ...
        for int32 in int32s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int32, "std_msgs/Byte")
            self.assertRaises(
                Exception, self.do_primitive_test, int32, "std_msgs/Int8")
            self.assertRaises(
        ...
        for int64 in int64s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int64, "std_msgs/Byte")
            self.assertRaises(
                Exception, self.do_primitive_test, int64, "std_msgs/Int8")
            self.assertRaises(
    ...
    def test_unsigned_int_base_msgs(self):
        ...
        for int16 in int16s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int16, "std_msgs/Char")
            self.assertRaises(
        ...
        for int32 in int32s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int32, "std_msgs/Char")
            self.assertRaises(
        ...
        for int64 in int64s:
            ...
            self.assertRaises(
                Exception, self.do_primitive_test, int64, "std_msgs/Char")
            self.assertRaises(
    ...
    def test_header_msg(self):
        msg = {"seq": 5, "stamp": {"secs": 12347, "nsecs": 322304},
