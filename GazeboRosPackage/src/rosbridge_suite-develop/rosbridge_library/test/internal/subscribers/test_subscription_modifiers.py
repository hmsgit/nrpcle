...
class TestMessageHandlers(unittest.TestCase):
    ...
    def test_queue_message_handler_stops(self):
        ...
        handler = subscribe.QueueMessageHandler(
            subscribe.MessageHandler(None, cb))
    ...
    # Used in standalone testing as well as the test_transition_functionality
    # test
...
# Test that each transition works and is stable
    def test_transitions(self):
        ...
        # Checking a QueueMessageHandler with rate limit can be generated both
        # ways
        handler = subscribe.MessageHandler(None, self.dummy_cb)
