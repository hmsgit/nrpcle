...
class AdvertisedServiceHandler():
    ...
    def __init__(self, service_name, service_type, protocol):
        ...
        # setup the service
        self.service_handle = rospy.Service(
            service_name, get_service_class(service_type), self.handle_request)
...
class AdvertiseService(Capability):
    ...
    advertise_service_msg_fields = [
        (True, "service", (str, unicode)), (True, "type", (str, unicode))]
    ...
    def advertise_service(self, message):
        ...
        if service_name in self.protocol.external_service_list.keys():
            ...
            self.protocol.external_service_list[
                service_name].service_handle.shutdown("Duplicate advertiser.")
