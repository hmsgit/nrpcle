...
config = {
    ...
    'packages': ['python_cle', 'python_cle.brainsim', 'python_cle.brainsim.__devices',
                 'python_cle.cle', 'python_cle.mocks', 'python_cle.mocks.brainsim',
                 'python_cle.mocks.brainsim.__devices', 'python_cle.mocks.cle',
                 'python_cle.mocks.robotsim', 'python_cle.tf_framework',
                 'python_cle.tf_framework'],
    'scripts': [],
    'name': 'python-cle',
